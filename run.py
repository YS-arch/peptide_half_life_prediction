...
from sklearn import linear_model, neighbors, svm, ensemble, gaussian_process,preprocessing
...
tasks = ['mouse_blood_nature','mouse_crude_intestinal_modification','mouse_blood_modification','Human_blood_nature', 'Human_blood_modification', 
		 ]

models = {linear_model.LinearRegression: 'LR', #linear_model.Perceptron: "Perception", #mouse crude ValueError("Unknown label type: %s" % repr(ys))
